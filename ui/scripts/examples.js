...
// @example sh.Board.send.instance - Create the board instance
...
// // @example sh.Board.send.version2 - Send version command (parsed response)
...
// @example sh.Board.command - Send version command (force parsed response)
